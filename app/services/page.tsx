        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-gray-400 max-w-2xl leading-relaxed">
              ...
              product. Built with modern technology, powered by intelligent
              solutions.
            </p>
          </div>
        </div>
            ...
            {[
              {
                step: "01",
                title: "Discovery",
                desc: "We discuss your project, goals, and requirements in detail.",
              },
              {
                step: "02",
                title: "Proposal",
                desc: "You receive a clear scope, timeline, and fixed-price quote.",
              },
              {
                step: "03",
                title: "Build",
                desc: "We develop your project with regular updates and demos.",
              },
              {
                step: "04",
                title: "Launch",
                desc: "We deploy, test, and hand over — with ongoing support.",
              },
            ].map((p) => (
      ...
      <section className="py-20 md:py-28 bg-gradient-to-br from-primary to-primary-dark">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-blue-100 mb-10 max-w-2xl mx-auto">
            Tell us about your idea. We&apos;ll respond with a free consultation
